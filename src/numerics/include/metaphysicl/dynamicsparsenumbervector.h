...
inline
DynamicSparseNumberVector<typename CompareTypes<T,T2>::supertype,
                          typename CompareTypes<IB,I2>::supertype>
if_else (const DynamicSparseNumberVector<B,IB>  & condition,
         const DynamicSparseNumberVector<T,I>   & if_true,
         const DynamicSparseNumberVector<T2,I2> & if_false)
{
