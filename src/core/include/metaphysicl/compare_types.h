...
ScalarBuiltin_true(unsigned long int);
ScalarBuiltin_true(unsigned long long int);
...
CompareTypes_all(unsigned long int, double);
CompareTypes_all(unsigned long int, long double);
CompareTypes_all(unsigned long long int, double);
CompareTypes_all(unsigned long long int, long double);
